    ...
    <body onload="relogio();">
            <%
                ...
                if((acao!=null)&&(acao.length()>0)){
                    ...
                    if(acao.equals("Buscar")){
                        paginasPOJO  paginas_POJO=new paginasPOJO();
                        paginas_POJO.setTitulo(Titulo);
                        paginas_BEAN=new paginasBEAN(paginas_POJO);
        ...
        <br>
            <form method="post" enctype="multipart/form-data"> 
                ...
                <br>
                <br>        
                <a href="./cadastro_patrocinio.jsp?id_menus=<%=id_menu%>&id_paginas=<%=id%>" target="_black" >cadastrar patrocineo</a>
                <a href="./cadastro_comentarios.jsp?id_menus=<%=id_menu%>&id_paginas=<%=id%>" target="_black" >cadastrar comentarios</a>
                <br>
                ...
                <tr>
                    ...
                    <td>
                        <form method="post" >
                            ...
                            <%}%>
                            <a href="./cadastro_fotos_paginas.jsp?id_paginas=<%=paginas_BEAN.getIDStr()%>" target="_black" ><input type="button" value="Mais fotos"    name="acao"></a>
                        </form>
                    </td>
                </tr>
<%
