...
<html>
    ...
    <body onload="relogio();">
        ...
        <%
            ...
            int acesso_total_por_menu=0;
            Vector registros_Paginas=new Vector();
            
            try{
                menus_BEAN__44.setID(id_menu);
                menus_BEAN__44.setID_menu(id_menu);
                acesso_total_por_menu=new contagemDAO(minhaConexao).contarTodosPorMenu(menus_BEAN__44);
                registros_Paginas=new paginasDAO(minhaConexao).buscarPaginasMaisAcessadas(menus_BEAN__44,1,20);

            }catch(Exception erro____){}
        ...
        <br>            
            ...
            <table cellpadding= "4" cellspacing = "0" border= "1" width= "400px">
                ...
                <%
                        ...
                        if((registros_Paginas!=null)&&(registros_Paginas.size()>0)){
                            for(int i=0;i<registros_Paginas.size();i++){
                                ...
                                acesso_total_por_menu+=paginas_BEAN.getContador();
                %>
                <tr>
                ...
                <%
                        ...
                        minhaConexao.Fechar();
                %>
                     acesso total por menu:<%=acesso_total_por_menu%>
            </table> 
