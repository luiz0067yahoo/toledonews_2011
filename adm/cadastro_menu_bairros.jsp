...
<%@page import="POJO.menusBairrosPOJO"%>
    ...
    <body onload="relogio();">
        <center>
            <%  
                ...
                menusBairrosBEAN menus_BEAN=new menusBairrosBEAN();
                menusBairrosDAO menus_DAO=new menusBairrosDAO(minhaConexao);
                ...
                if((acao!=null)&&(acao.length()>0)){  
                    ...
                    if(acao.equals("Buscar")){
                        menusBairrosPOJO  menus_POJO=new menusBairrosPOJO();
                        menus_POJO.setTitulo(Titulo);
                        menus_BEAN=new menusBairrosBEAN(menus_POJO);
                        ...
                        mensagem_Titulo="";
                        mensagem_acao="";
                        menus_BEAN=((menusBairrosBEAN)menus_DAO.buscarID(menus_BEAN));
                        ...
                        <%
                            if((registros_menus!=null)&&(registros_menus.size()>0)){
                                for(int i=0;i<registros_menus.size();i++){
                                    menus_BEAN=((menusBairrosBEAN)registros_menus.get(i));
                        %>
                        <tr>
