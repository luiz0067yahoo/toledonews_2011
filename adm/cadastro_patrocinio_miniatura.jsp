                ...
                if((acao!=null)&&(acao.length()>0)){
                       ...
                       if(acao.equals("Salvar")){
                                if (mensagem_titulo.length()==0){                             
                                    try{
                                         miniatura=request2.upload(//mostro o nome do arquivo enviado
                                                "miniatura",//name do input type file
                                                "publicidadeinicial",//pasta sub sequente da pasta upload
                                                new String[]{"jpg","gif","png","bmp"},//extesoes de arquivos 
                                                10*1024*1024//10 mb
                                        );
                                        miniatura=request2.redimensionarImagem(
                                            "publicidadeinicial"//pasta sub sequente da pasta upload
                                            ,miniatura//nome do arquivo enviado
                                            ,new String[]{""}//prefixos
                                            ,new Dimension[]{
                                                new Dimension(90,90)//tamanho m_ 360px de largura e 240px de altura
                                            }
                                        );
                                        try{patrocinio_BEAN.setminiatura(miniatura);}catch(Exception erro){mensagem_miniatura=erro.getMessage();};
                                        
                                        
                                        
                                        if ((id!=null)&&(id.length()!=0))
                                            
                                        if(mensagem_miniatura.length()==0){
                                ...
                                if (
                                    ...
                                    patrocinio_BEAN=patrocinio_DAO.excluirminiatura(patrocinio_BEAN,functions.path_upload); 
                                    if(
                                            (patrocinio_BEAN!=null)
                                            &&(patrocinio_BEAN.getidStr()!=null)
                                            &&(patrocinio_BEAN.getminiatura()==null)
                                    ){
